...
#### Shells
 ...
 4. What does `pwd` do?
 5. What does `mkdir PTUA2023` do?
 6. What does `cd PTUA2023` do?
 7. Enter into your desktop folder by using `cd Desktop`
 8. Create a directory called `PTUA2023-lab2`
...
#### Python Interpretor
 ...
 5. How do you enter and exit interactive help? (hint: try `Esc` `:` `q`)
